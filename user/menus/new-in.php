...
<head>
    ...
    <title>New In | Shapehugs European Boutique Fashion</title>
    <!-- Google Fonts -->
    <link
...
<body>
            ...
            <div class="container">
                <ul>
                    <li class="has-submenu has-megamenu">
                        <a href="new-in.php" class="nav-link active">New In</a>
                        <div class="megamenu">
    ...
    <main class="category-page">
        ...
        <section class="category-hero" style="background: #fbf9f7; padding: 80px 0; text-align: center;">
            <div class="container">
                <h1 class="serif" style="font-size: 48px; margin-bottom: 15px;">New In</h1>
                <p class="text-muted small text-uppercase letter-spacing-2">Fresh arrivals for the new season</p>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                ...
                <!-- Product Grid -->
                <div class="product-grid" data-api-collection="new-in" data-api-limit="4" data-api-replace="true">
                    ...
                    <div class="product-card" data-id="17" data-name="Eyelet Lace Blouse" data-price="48.00" data-image="../../assets/images/p2.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge">New Arrival</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Eyelet Lace Blouse</h3>
                            <p class="product-price">$48.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="18" data-name="Chiffon Pleat Skirt" data-price="58.00" data-image="../../assets/images/p3.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge">New Arrival</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/p3.png" alt="Chiffon Skirt">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Chiffon Pleat Skirt</h3>
                            <p class="product-price">$58.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="19" data-name="Boho Maxi Dress" data-price="89.00" data-image="../../assets/images/hero.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge">New Arrival</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/hero.png" alt="Boho Dress">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Boho Maxi Dress</h3>
