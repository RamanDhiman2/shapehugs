...
<head>
    ...
    <title>Sale | Shapehugs European Boutique Fashion</title>
    <!-- Google Fonts -->
    <link
...
<body>
    ...
    <!-- Announcement Bar -->
    <div class="announcement-bar" style="background: #d10000;">
        EXTRA 20% OFF ALL SALE ITEMS WITH CODE: FINAL20
    </div>
        ...
        <nav class="nav-menu">
            ...
            <div class="container">
                <ul>
                    ...
                    <li><a href="sale.php" class="nav-link active" style="color: #d10000;">Sale</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <main class="category-page">
        <!-- Category Header -->
        <section class="category-hero" style="background: #fffafa; padding: 80px 0; text-align: center;">
            <div class="container">
                <h1 class="serif" style="font-size: 48px; margin-bottom: 15px; color: #d10000;">The Sale</h1>
                <p class="text-muted small text-uppercase letter-spacing-2">Limited time offers on seasonal favorites
                </p>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="category-toolbar"
                    style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px; border-bottom: 1px solid var(--border-color); padding-bottom: 20px;">
                    <div class="filter-trigger"
                        style="cursor: pointer; font-size: 12px; text-transform: uppercase; font-weight: 600; letter-spacing: 1px;">
                    ...
                    <div class="sort-selector">
                        <select
                            style="border: none; background: none; font-size: 12px; text-transform: uppercase; font-weight: 600; cursor: pointer; outline: none;">
                ...
                <div class="product-grid" data-api-collection="sale" data-api-limit="4" data-api-replace="true">
                    <div class="product-card" data-id="21" data-name="Floral Ruffle Skirt" data-price="32.00"
                        ...
                        <div class="product-image-wrapper">
                            <span class="product-badge" style="background: #d10000;">40% OFF</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/p3.png" alt="Ruffle Skirt">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick
                                    View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to
                                    Cart</button>
                            </div>
                        </div>
                        <div class="product-info">
                            <h3 class="product-name serif">Floral Ruffle Skirt</h3>
                            <p class="product-price"><span class="text-muted text-decoration-line-through me-2"
                                    style="font-weight: 400; font-size: 0.9em;">$55.00</span>$32.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="22" data-name="Knit Polo Top" data-price="25.00"
                        data-image="../../assets/images/p2.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge" style="background: #d10000;">50% OFF</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/p2.png" alt="Knit Top">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick
                                    View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Knit Polo Top</h3>
                            <p class="product-price"><span class="text-muted text-decoration-line-through me-2"
                                    style="font-weight: 400; font-size: 0.9em;">$50.00</span>$25.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="23" data-name="Linen Sundress" data-price="45.00"
                        data-image="../../assets/images/hero.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge" style="background: #d10000;">30% OFF</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/hero.png" alt="Sundress">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick
                                    View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Linen Sundress</h3>
                            <p class="product-price"><span class="text-muted text-decoration-line-through me-2"
                                    style="font-weight: 400; font-size: 0.9em;">$65.00</span>$45.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="24" data-name="Straw Handbag" data-price="28.00"
                        data-image="../../assets/images/cat_acc.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge" style="background: #d10000;">FASHION DEAL</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/cat_acc.png" alt="Handbag">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick
                                    View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Straw Handbag</h3>
                            <p class="product-price"><span class="text-muted text-decoration-line-through me-2"
                                    style="font-weight: 400; font-size: 0.9em;">$42.00</span>$28.00</p>
                        </div>
                    </div>
                </div>
            </div>
