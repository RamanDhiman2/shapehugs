...
<head>
    ...
    <title>Bestsellers | Shapehugs European Boutique Fashion</title>
    <!-- Google Fonts -->
    <link
...
<body>
        ...
        <nav class="nav-menu">
            ...
            <div class="container">
                <ul>
                    ...
                    <li><a href="bestsellers.php" class="nav-link active">Bestsellers</a></li>
    ...
    <main class="category-page">
        ...
        <section class="category-hero" style="background: #fbf9f7; padding: 80px 0; text-align: center;">
            <div class="container">
                <h1 class="serif" style="font-size: 48px; margin-bottom: 15px;">Bestsellers</h1>
                <p class="text-muted small text-uppercase letter-spacing-2">The pieces you love most</p>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                ...
                <!-- Product Grid -->
                <div class="product-grid" data-api-collection="bestsellers" data-api-limit="4" data-api-replace="true">
                    ...
                    <div class="product-card" data-id="3" data-name="Pleated High-Waist Skirt" data-price="54.00" data-image="../../assets/images/p3.png">
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif"><a href="../pages/product-view.php" style="color: inherit; text-decoration: none;">Pleated High-Waist Skirt</a></h3>
                    ...
                    <div class="product-card" data-id="1" data-name="The Sage Silk Midi" data-price="68.00" data-image="../../assets/images/p1.png">
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif"><a href="../pages/product-view.php" style="color: inherit; text-decoration: none;">The Sage Silk Midi</a></h3>
                            <p class="product-price">$68.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="20" data-name="Embroidered Linen Shirt" data-price="52.00" data-image="../../assets/images/p2.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge">Customer Favorite</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/p2.png" alt="Linen Shirt">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Embroidered Linen Shirt</h3>
