...
<head>
    ...
    <title>Accessories | Shapehugs European Boutique Fashion</title>
    <!-- Google Fonts -->
    <link
...
<body>
        ...
        <nav class="nav-menu">
            ...
            <div class="container">
                <ul>
                    ...
                    <li><a href="accessories.php" class="nav-link active">Accessories</a></li>
    ...
    <main class="category-page">
        ...
        <section class="category-hero" style="background: #fbf9f7; padding: 80px 0; text-align: center;">
            <div class="container">
                <h1 class="serif" style="font-size: 48px; margin-bottom: 15px;">Accessories</h1>
                <p class="text-muted small text-uppercase letter-spacing-2">Finishing touches for a curated look</p>
            </div>
        </section>
                ...
                <div class="product-grid">
                    ...
                    <div class="product-card" data-id="13" data-name="Golden Pearl Earrings" data-price="28.00" data-image="../../assets/images/cat_acc.png">
                        <div class="product-image-wrapper">
                            ...
                            <img src="../../assets/images/cat_acc.png" alt="Earrings">
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Golden Pearl Earrings</h3>
                            <p class="product-price">$28.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="14" data-name="Suede Bucket Bag" data-price="145.00" data-image="../../assets/images/cat_acc.png">
                        <div class="product-image-wrapper">
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/cat_acc.png" alt="Bucket Bag">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Suede Bucket Bag</h3>
                            <p class="product-price">$145.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="15" data-name="Silk Scarf Gardenia" data-price="35.00" data-image="../../assets/images/cat_acc.png">
                        <div class="product-image-wrapper">
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/cat_acc.png" alt="Silk Scarf">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Silk Scarf Gardenia</h3>
                            <p class="product-price">$35.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="16" data-name="Minimalist Gold Watch" data-price="190.00" data-image="../../assets/images/cat_acc.png">
                        <div class="product-image-wrapper">
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/cat_acc.png" alt="Gold Watch">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Minimalist Gold Watch</h3>
