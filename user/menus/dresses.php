...
<head>
    ...
    <title>Dresses | Shapehugs European Boutique Fashion</title>
    <!-- Google Fonts -->
    <link
...
<body>
            ...
            <div class="container">
                <ul>
                    ...
                    <li class="has-submenu has-dropdown">
                        <a href="dresses.php" class="nav-link active">Dresses</a>
                        <div class="submenu">
    ...
    <main class="category-page">
        ...
        <section class="category-hero" style="background: #fbf9f7; padding: 80px 0; text-align: center;">
            <div class="container">
                <h1 class="serif" style="font-size: 48px; margin-bottom: 15px;">Dresses</h1>
                <p class="text-muted small text-uppercase letter-spacing-2">Elevated silhouettes for every occasion</p>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                ...
                <!-- Product Grid -->
                <div class="product-grid" data-api-category="dresses" data-api-limit="4" data-api-replace="true">
                    <!-- Product 1 -->
                    <div class="product-card" data-id="1" data-name="The Sage Silk Midi" data-price="68.00" data-image="../../assets/images/p1.png">
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">The Sage Silk Midi</h3>
                            <p class="product-price">$68.00</p>
                        </div>
                    </div>

                    <!-- Product 4 -->
                    <div class="product-card" data-id="4" data-name="Vintage Floral Dress" data-price="72.00" data-image="../../assets/images/hero.png">
                        <div class="product-image-wrapper">
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Vintage Floral Dress</h3>
                            <p class="product-price">$72.00</p>
                        </div>
                    </div>

                    <!-- Additional Mock Items for Dresses -->
                    <div class="product-card" data-id="5" data-name="Linen Wrap Dress" data-price="85.00" data-image="../../assets/images/cat_dresses.png">
                        <div class="product-image-wrapper">
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/cat_dresses.png" alt="Linen Dress">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Linen Wrap Dress</h3>
                            <p class="product-price">$85.00</p>
                        </div>
                    </div>

                    <div class="product-card" data-id="6" data-name="Evening Velvet Midi" data-price="120.00" data-image="../../assets/images/hero2.png">
                        <div class="product-image-wrapper">
                            <span class="product-badge">Exclusive</span>
                            <i class="fa-regular fa-heart wishlist-icon"></i>
                            <img src="../../assets/images/hero2.png" alt="Velvet Dress">
                            <div class="product-actions">
                                <button class="action-btn quick-view"><i class="fa-regular fa-eye"></i> Quick View</button>
                                <button class="action-btn add-to-cart"><i class="fa-solid fa-plus"></i> Add to Cart</button>
                            </div>
                        ...
                        <div class="product-info">
                            <h3 class="product-name serif">Evening Velvet Midi</h3>
