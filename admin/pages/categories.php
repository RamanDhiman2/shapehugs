...
<head>
    ...
    <style>
        ...
        .cat-card { background: #fff; border: 1px solid var(--border-color); border-radius: 8px; overflow: hidden; position: relative; }
        .cat-img { width: 100%; height: 200px; object-fit: cover; }
        .cat-info { padding: 20px; }
        .cat-actions { position: absolute; top: 10px; right: 10px; background: #fff; padding: 5px 10px; border-radius: 4px; display: none; }
        .cat-card:hover .cat-actions { display: block; }
        /* Dropdown Styles */
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="cat-grid">
            <div class="cat-card">
                <img src="../../assets/images/cat_dresses.png" alt="Dresses" class="cat-img">
                <div class="cat-actions"><i class="fa-solid fa-pen"></i></div>
                <div class="cat-info">
                    <h3 class="serif" style="font-size: 18px;">Dresses</h3>
                    <p class="small text-muted">24 Products</p>
                </div>
            </div>
            <div class="cat-card">
                <img src="../../assets/images/cat_tops.png" alt="Tops" class="cat-img">
                 <div class="cat-actions"><i class="fa-solid fa-pen"></i></div>
                <div class="cat-info">
                    <h3 class="serif" style="font-size: 18px;">Tops</h3>
                    <p class="small text-muted">18 Products</p>
                </div>
            </div>
            <div class="cat-card">
                <img src="../../assets/images/cat_bottoms.png" alt="Bottoms" class="cat-img">
                 <div class="cat-actions"><i class="fa-solid fa-pen"></i></div>
                <div class="cat-info">
                    <h3 class="serif" style="font-size: 18px;">Bottoms</h3>
                    <p class="small text-muted">12 Products</p>
                </div>
            </div>
            <div class="cat-card">
                <img src="../../assets/images/cat_accessories.png" alt="Accessories" class="cat-img">
                 <div class="cat-actions"><i class="fa-solid fa-pen"></i></div>
                <div class="cat-info">
                    <h3 class="serif" style="font-size: 18px;">Accessories</h3>
                    <p class="small text-muted">8 Products</p>
                </div>
            </div>
        </div>
    </main>
