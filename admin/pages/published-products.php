...
<head>
    ...
    <title>Published Products | Shapehugs Admin</title>
    ...
    <main class="main-content">
        <div class="page-header">
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <h1 class="serif" style="font-size: 28px; margin: 0;">Published Products</h1>
            </div>
                    ...
                    <tbody>
                        <tr>
                            <td style="display: flex; align-items: center;">
                                <a href="product-view.php"><img src="../../assets/images/p1.png" alt="Product" class="product-thumb"></a>
                                <div><a href="product-view.php" style="color: inherit; text-decoration: none;"><span style="font-weight: 500;">The Sage Silk Midi</span></a><br><span style="font-size: 12px; color: var(--muted-text);">ID: #8392</span></div>
                            </td>
                            <td>Dresses</td>
                            <td>$68.00</td>
                            <td>24</td>
                        ...
                        <tr>
                            <td style="display: flex; align-items: center;">
                                <a href="product-view.php"><img src="../../assets/images/p2.png" alt="Product" class="product-thumb"></a>
                                <div><a href="product-view.php" style="color: inherit; text-decoration: none;"><span style="font-weight: 500;">White Lace Blouse</span></a><br><span style="font-size: 12px; color: var(--muted-text);">ID: #8393</span></div>
                            </td>
                            <td>Tops</td>
                            <td>$45.00</td>
                            <td>12</td>
