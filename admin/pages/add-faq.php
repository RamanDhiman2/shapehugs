...
<head>
    ...
    <title>Add FAQ | Shapehugs Admin</title>
    ...
    <main class="main-content">
        <div class="page-header">
            <div style="display: flex; align-items: center; gap: 15px;">
                ...
                <div>
                    <h1 class="serif" style="font-size: 28px; margin: 0;">Add New FAQ</h1>
                    <p class="text-muted small text-uppercase letter-spacing-1" style="margin: 0;">Create a new frequently asked question</p>
                </div>
            </div>
            <div style="display: flex; gap: 10px;">
                ...
                <button type="submit" form="faq-form" class="btn-primary" style="padding: 12px 25px;">Publish FAQ</button>
            </div>
        </div>
        ...
        <div class="account-card">
            <form id="faq-form" action="faqs.php">
                <div class="form-group">
                    ...
                    <input type="text" id="f-question" value="" required placeholder="e.g. How long does shipping take?">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="f-answer" rows="6" placeholder="Provide a detailed answer here..."></textarea>
                </div>
            </form>
        </div>
    </main>
