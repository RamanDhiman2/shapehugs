...
<head>
    ...
    <title>Add New Product | Shapehugs Admin</title>
    <!-- Google Fonts -->
    ...
    <main class="main-content">
        <div class="page-header">
                <div style="display: flex; align-items: center; gap: 15px;">
                    ...
                    <div>
                        <h1 class="serif" style="font-size: 28px; margin: 0;">Add New Product</h1>
                        <p class="text-muted small text-uppercase letter-spacing-1" style="margin: 0;">Fill in the details to create a new product</p>
                    </div>
                </div>
                <div style="display: flex; gap: 10px;">
                    <a href="products.php" class="btn-primary" style="background: transparent; color: var(--text-color); border: 1px solid var(--border-color); padding: 12px 25px;">Cancel</a>
                    <button type="submit" form="product-form" class="btn-primary">Publish Product</button>
                </div>
            </div>

            <div class="account-card">
                <form id="product-form" action="products.php">
                    <div class="form-row">
                        <div class="form-group">
                            <label for="p-name">Product Name</label>
                            <input type="text" id="p-name" value="" required placeholder="e.g. The Sage Silk Midi">
                        </div>
                        <div class="form-group">
                            <label for="p-sku">SKU</label>
                            <input type="text" id="p-sku" value="" required placeholder="e.g. SH-2024-002">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="p-price" value="" step="0.01" placeholder="e.g. 68.00">
                        </div>
                        <div class="form-group">
                            <label for="p-stock">Stock Quantity</label>
                            <input type="number" id="p-stock" value="" placeholder="e.g. 150">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="p-desc" rows="5" style="width: 100%; padding: 15px; border: 1px solid var(--border-color); border-radius: 2px; outline: none; font-family: inherit;" placeholder="Add a detailed description for your product..."></textarea>
                    </div>

                    <div class="form-group">
                        <label>Product Images</label>
                        <input type="file" multiple class="form-control" style="padding: 10px; background: #fbf9f7;">
                        <p class="small text-muted" style="margin-top: 5px;">Hold Ctrl or Shift to select multiple images.</p>
                    </div>
                </form>
            </div>
    </main>
